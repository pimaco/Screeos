module.exports = function (creep) {
    if (!creep.memory.currentFlag || creep.memory.statusHarvesting == undefined || creep.memory.statusHarvesting == false || creep.carry.energy == creep.carryCapacity || Game.time % 10 == 0) {
        if (!creep.memory.currentFlag || creep.memory.currentFlag == undefined ) {
            creep.memory.currentFlag = Game.flags.haulEnergy2;
        }
        ...
        if (creep.memory.currentFlag == undefined) {
            ...
            var flag = Game.flags.haulEnergy2;
            var sourceKeeper = [];
